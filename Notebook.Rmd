...
+ [En espanol](https://rstudio.com/wp-content/uploads/2015/04/ggplot2-spanish.pdf) 
...
Density plots use only an x variable, no y
...
# Back to the data for a moment because we it's helpful to understand data structure to use ggplot. 
...
### That grey in the side bars is still pretty ugly, add a custom theme piece
